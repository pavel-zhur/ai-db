...
class TestConfig:
    ...
    def test_default_config(self):
        ...
        try:
            ...
            # Restore environment
            if git_repo_path:
                os.environ["AI_HUB_GIT_REPO_PATH"] = git_repo_path
            if api_key:
                os.environ["AI_HUB_AI_DB_API_KEY"] = api_key
    ...
    def test_cors_origins_list(self):
        ...
        with patch.dict(
            os.environ, {"AI_HUB_CORS_ORIGINS": '["http://localhost:3000", "https://example.com"]'}
        ):
            config = Config()
