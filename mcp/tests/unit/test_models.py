...
from ai_mcp.models.ai_frontend import (
...
class TestAIDBModels:
    ...
    def test_transaction_request_validation(self):
        ...
        # With transaction ID
        request = TransactionRequest(transaction_id="tx-123", commit_message="Test commit")
        assert request.transaction_id == "tx-123"
...
class TestAIFrontendModels:
    ...
    def test_frontend_request_validation(self):
        ...
        # With transaction
        request = FrontendRequest(request="Update form", transaction_id="tx-789")
    ...
    def test_frontend_response_validation(self):
        ...
        # Error response
        response = FrontendResponse(
            status="error", ai_comment="Generation failed", error="Invalid request"
        )
    ...
    def test_frontend_info_response_validation(self):
        ...
        response = FrontendInfoResponse(
            components=[{"name": "UserList", "path": "/components/UserList.tsx"}],
            semantic_docs={"UserList": "Displays list of users"},
        )
