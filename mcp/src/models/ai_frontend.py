...
class FrontendRequest(BaseModel):
    ...
    request: str = Field(..., description="Natural language request for frontend generation/modification")
...
class FrontendResponse(BaseModel):
    ...
    generated_files: Optional[list[str]] = Field(None, description="List of generated/modified files")
