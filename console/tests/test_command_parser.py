...
class TestCommandParser:
    ...
    def test_transaction_commands(self, parser):
    ...
    def test_output_format_command(self, parser):
    ...
    def test_schema_commands(self, parser):
    ...
    def test_data_commands(self, parser):
    ...
    def test_view_commands(self, parser):
    ...
    def test_frontend_commands(self, parser):
    ...
    def test_query_commands(self, parser):
    ...
    def test_destructive_operation_detection(self, parser):
